...
class AwningDetailScreen extends StatelessWidget {
  const AwningDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(
        0xFF050505,
      ), // Pure dark premium void background
      appBar: AppBar(
        ...
        title: FittedBox(
          ...
          child: Text(
            "${'awning'.tr().toUpperCase()} OVERRIDE",
            style: TextStyle(
        ...
        builder: (context, state) {
          return Padding(
            ...
            child: Column(
              ...
              children: [
                // Top massive Hero Icon with subtle glowing shadow
                Center(
                  child: Hero(
                    tag: 'hero_awning_icon',
                    child: Container(
                ...
                Text(
                  '${state.awningPosition.toInt()}%',
                  style: TextStyle(
                    fontSize: (screenWidth * 0.12).clamp(36.0, 64.0),
                    fontWeight: FontWeight.bold,
                    color: const Color(0xFFFFFFFF),
                    shadows: const [Shadow(color: Color(0x8000E5FF), blurRadius: 12)],
                  ),
                  textAlign: TextAlign.center,
                ),
                SizedBox(height: (screenHeight * 0.05).clamp(24.0, 64.0)),

                // Massive custom-styled slider core front and center
                if (state.isAutoMode)
                  Container(
                    padding: const EdgeInsets.symmetric(
                      vertical: 12,
                      ...
                      child: Container(
                        ...
                        child: SliderTheme(
                          data: SliderTheme.of(context).copyWith(
                            trackHeight: 24.0, // Massive responsive tactile track
                          ...
                          child: Slider(
                            value: state.awningPosition.clamp(0, 100),
                            min: 0,
                            max: 100,
                            divisions: 100,
                            label: '${state.awningPosition.toInt()}%',
